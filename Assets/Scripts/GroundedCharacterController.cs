...
public class GroundedCharacterController : MonoBehaviour
{
    ...
    public void UpdateEdgeCollidersUpright()
    {
        ...
        aboveCollider.transform.localPosition = new Vector3(0, bc.offset.y * 2 + bc.size.x / 2, aboveCollider.transform.localPosition.z);
        belowCollider.transform.localPosition = new Vector3(0, -bc.size.x / 2, aboveCollider.transform.localPosition.z);
